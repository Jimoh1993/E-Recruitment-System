    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-sm-9">
          <h3>Good Relationship with  Management Staff across all Departments & Units</h3>
          <p>Development of successful, long term, strategic relationships between academic staff and non-academic staff, based on Knowledge, Integrity & Leadership in achieving best practice among other institution in the World. In the employment model, HR professionals work closely with institution leaders and line management to achieve shared organisational objectives.</p>
        </div>
  ...
  <div class="container">
        <div class="row">
      <div class="col-md-12">
        <div class="aligncenter"><h2 class="aligncenter">ADVERTISEMENTS</h2><!-- Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores quae porro consequatur aliquam, incidunt eius magni provident, doloribus omnis minus ovident, doloribus omnis minus temporibus perferendis nesciunt.. --></div>
        <p><?php include_once("advert.php");?></p>
        <br/>
      </div>
    </div>
    ...
    ?>
            <!--<div class="col-sm-4 info-blocks">
                ...
                <div class="info-blocks-in">
                    ...
                    <!-- <p><?php echo $company->COMPANYMISSION;?></p> this line shoulb be comment out when un-comment>
